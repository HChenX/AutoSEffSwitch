...
public class NewAutoSEffSwitch extends BaseHC {
    ...
    @Deprecated
    private OldAutoSEffSwitch mOldAutoSEffSwitch;
    ...
    public void init() {
        if (ModuleConfig.useNewVersion) {
            ...
            mOldAutoSEffSwitch = new OldAutoSEffSwitch();
            mOldAutoSEffSwitch.init();
        }
    }
    ...
    protected void onApplicationAfter(Context context) {
        mContext = context;
        if (!ModuleConfig.useNewVersion) {
            if (mOldAutoSEffSwitch != null)
                mOldAutoSEffSwitch.OldOnApplicationAfter(context);
            return;
        }
